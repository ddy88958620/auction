...
/**
 * 抽奖工具类,概率和可以不等于1 概率为百分数去掉百分号的部分，如10%，则为10 抽奖操作如下： 1.输入抽奖概率集合，【抽奖概率集合为{10.0,
 * 20.0, 30.0}】 2.生成连续集合， 【生成的连续集合为{(0.0, 10.0],(10.0, 30.0],(30.0, 60.0]}】
...
public class LotteryUtil {
	...
	public class ContinuousList {
		...
		public String toString() {
			return "ContinuousList [minElement=" + minElement + ", maxElement="
					+ maxElement + "]";
		}
	 ...
	 *            为奖品的概率
	 */
	public LotteryUtil(List<LotteryPrize> list) {
		...
		for (LotteryPrize ft : list) {
			minElement = maxElement;
			maxElement = maxElement + ft.getPrizeRate().multiply(new BigDecimal(10000)).doubleValue();
