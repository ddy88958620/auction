...
public interface LotteryPrizeService {
     ...
     * @return ServiceResult
     * @throws Exception 更新失败，抛出异常
     */
    ServiceResult updatePrizePlanAndValid(List<String> plan1PrizeNoList, List<String> plan2PrizeNoList, String validPlan) throws Exception;
     ...
     * @return 抽奖结果
     */
    ServiceResult getLotteryPrizeByRandom(Integer userId,String isExchange) throws Exception;
}
