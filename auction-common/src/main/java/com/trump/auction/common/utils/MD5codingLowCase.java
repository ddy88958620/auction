...
public class MD5codingLowCase {
	...
	public String getMD5key(String ticketId, String visitDate) {
		...
		try {
			return m.code(m.code(ticketId + visitDate + "FE0VXC93MRADLKFO32559FREWEQDFBVZX"));
	...
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		/**
		 * “app_key=qzbauzh8cl2qzd9qssnkrfly4t4nk6m6&batch_num=ces001&content=【
		 * 流浪猫】尊敬的用户，本次验证码为123456，请勿泄露！&dest_id=15267797477&dest_id=13968880707&
		 * mission_num=test001&mission_num=test002&nonce_str=5iliulang&sms_type=
		 * verify_code&time_stamp=20160520170033&app_secret=
		 * a1df1b975bd9efc6a0d6d7d4c496f1007164”
		 * 
