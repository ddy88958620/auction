...
public class QueryOrderBuilder {
    ...
    private static final List<String> required = Arrays.asList(PARAM_APPID, PARAM_MCHID, PARAM_NONCE,  PARAM_OUT_TRADE_NO);
    ...
    public QueryOrderBuilder setKey(String key) {
     ...
     * @return
     */
    public QueryOrderBuilder setAppId(String appId) {
     ...
     * @return
     */
    public QueryOrderBuilder setMchId(String mchId) {
     ...
     * @return
     */
    public QueryOrderBuilder setNonceStr(String nonceStr) {
     ...
     * @return
     */
    public QueryOrderBuilder setBody(String body) {
     ...
     * @return
     */
    public QueryOrderBuilder setOutTradeNo(String outTradeNo) {
     ...
     * @return
     */
    public QueryOrderBuilder setTotalFee(Integer totalFee) {
     ...
     * @return
     */
    public QueryOrderBuilder setBillCreateIP(String ip) {
     ...
     * @return
     */
    public QueryOrderBuilder setNotifyUrl(String notifyUrl) {
     ...
     * @return
     */
    public QueryOrderBuilder setTradeType(String tradeType) {
     ...
     * @return
     */
    public QueryOrderBuilder setDeviceInfo(String deviceInfo) {
     ...
     * @return
     */
    public QueryOrderBuilder setDetail(String detail) {
     ...
     * @return
     */
    public QueryOrderBuilder setAttach(String attach) {
     ...
     * @return
     */
    public QueryOrderBuilder setFeeType(String feeType) {
     ...
     * @return
     */
    public QueryOrderBuilder setTimeStart(String timeStart) {
     ...
     * @return
     */
    public QueryOrderBuilder setTimeExpire(String timeExpire) {
     ...
     * @return
     */
    public QueryOrderBuilder setGoodSTag(String goodsTag) {
