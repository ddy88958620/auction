...
import com.trump.auction.web.configure.ApplicationContextRegister;
...
public class UploadUtils {
	...
	public static String getRealPath(String path) {
		String fileRealPathDir = ApplicationContextRegister.getWebApplicationContext().getServletContext().getRealPath(path);
