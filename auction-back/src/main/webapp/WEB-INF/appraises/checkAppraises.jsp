...
<form class="layui-form  layui-form-pane1 pzjzsj" action="" id="form" style="margin-left: 30px">
    ...
    <div class="layui-form-item" >
        ...
        <div class="example" style="margin-top: 10px;height: 60px" id="mutiPic">
            <%--<table  class="example">--%>
                <%--<tr id="tr1">--%>
    ...
    <div class="layui-form-item" style="margin-top: 200px;margin-left: 395px">
        <div class="layui-input-block">
            <%--<button class="layui-btn" type="submit" lay-submit lay-filter="check1">审核并发布</button>--%>
    ...
    layui.use('layer', function(){ //独立版的layer无需执行这一句
        ...
        var active = {
            setTop: function(){
                ...
                url =  url + "level=" + level+"&id="+id+"&content="+content+"&valueArray="+picArray+"&isShow="+isShow;
                //多窗口模式，层叠置顶
                layer.open({
                    type: 2 //此处以iframe举例
                    ,title: '确认奖励级别'
