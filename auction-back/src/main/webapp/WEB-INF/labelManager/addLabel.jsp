...
<form class="layui-form  layui-form-pane1 pzjzsj" action="" id="form" style="margin-left: 30px">
    <div class="layui-form-item">
        <div class="layui-form-inline" style="margin-left: 95px;margin-top: 30px">
            ...
            <div class="layui-input-inline" style="width: 30%;">
                <input id="labelName" name="labelName" type="text" unselectable="on" class="layui-input"   />
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item" style="margin-left: 95px;margin-top: 30px">
        ...
        <div id="mutiPic"></div>
        <input type="hidden" id="labelPic" name="labelPic" value=""/>
        <p id="labelText"></p>
    </div>
    <div class="layui-form-item" style="margin-left: 95px;margin-top: 30px">
        <label class="layui-form-label">启用/禁用:</label>
        <div class="layui-input-block">
            <input type="radio" name="labelStatus" value="0" title="启用" checked="checked">
            <input type="radio" name="labelStatus" value="1" title="禁用">
        </div>
    </div>
...
<script>
    ...
    layui.use(['form','layer','upload'], function() {
        ...
        form.on('submit(confirm)', function(data) {
            ...
            $.ajax({
                type : "post",
                url : "${path}/labelManager/saveLabelManager",
                data : {'labelPic':labelPic,'labelStatus':labelStatus,'labelName':labelName},
                dataType : "json",
