...
<script>
    ...
    layui.use(['table', 'form'], function () {
        ...
        table.render({
            ...
            cols: [[{
                ...
                title: '充值金额',
                align: 'center',
                templet: '<div>{{toMoney(d.transactionType)}}</div>'
            }, {
                field: 'transactionCoin',
                title: '充值结果',
                align: 'center',
                width: 220,
                templet: '<div>{{toTransactionCoin(d.transactionCoin)}}</div>'
                /* field: 'balanceType',
                 title: '收支类型',
                 align: 'center',
                 width: 200,
    ...
    function toTransactionCoin(transactionCoin) {
        return "拍币+"+transactionCoin/100;
    }
    function toMoney(transactionCoin) {
        if (transactionCoin==null ||transactionCoin ==""){
            return 0;
        }
        return transactionCoin/100
    }
</script>
</body>
</html>