...
<form id="form" class="layui-form  layui-form-pane1 pzjzsj" method="POST" style="margin-left: 20px;margin-top: 20px;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="activityName" value="${activity.activityName}" lay-verify="required" autocomplete="off" class="layui-input" maxlength="20">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input id="startTime" type="text" name="startDate" lay-verify="required" value='<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
                                                                              value="${activity.startTime}" />' autocomplete="off" class="layui-input">
        </div>

        <div class="layui-form-mid">至</div>
        <div class="layui-input-inline">
            <input id="endTime" type="text" name="endDate" lay-verify="required" value='<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
                                                                              value="${activity.endTime}" />' autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="activityUrl" lay-verify="required" value="${activity.activityUrl}" autocomplete="off" class="layui-input" style="width:415px">
        </div>
    </div>
        ...
        <div class="layui-input-block">
            <div class="layui-upload">
                ...
                <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;width: 105px;"
                    ...
                    <input type="hidden" id="imgUrl" name="picUrl" value="${activity.picUrl}"/>
                    <p id="upHeadTxt"></p>
                </blockquote>
            </div>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="title" value="${activity.title}"
                   autocomplete="off" class="layui-input" lay-verify="required" maxlength="12">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">分享副标题：</label>
        <div class="layui-input-inline">
            <input type="text" name="subTitle" value="${activity.subTitle}"
                   autocomplete="off" class="layui-input" lay-verify="required" maxlength="25" style="width:415px">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="sharerPoints" value="${activity.sharerPoints}"
                   autocomplete="off" class="layui-input" lay-verify="required|integer" lay-verify="required">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="sharerCoin" value="${activity.sharerCoin}"
                   autocomplete="off" class="layui-input" lay-verify="required|integer" lay-verify="required">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="registerPoints" value="${activity.registerPoints}"
                   autocomplete="off" class="layui-input" lay-verify="required|integer" lay-verify="required">
        </div>
        <div class="layui-form-mid layui-word-aux">积分</div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"></label>
        <div class="layui-input-inline">
            <input type="text" name="registerCoin" value="${activity.registerCoin}"
