...
<form class="layui-form  layui-form-pane1 pzjzsj" method="POST">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:30%">
            <input type="text" lay-verify="required|id" disabled name="id" id="id" class="layui-input"
 ...
 <%--   <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">手续费/次</label>
            <div class="layui-input-inline" style="width:30%">
                <input type="text" lay-verify="required|poundage" name="poundage" class="layui-input"
                       autocomplete="off" placeholder="规则1" value="${auctionRule.poundage}"/>
            </div>
        拍币
    </div>
<%--    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">差价购买</label>
            <div class="layui-input-inline" style="width:30%">
                <select name="differenceFlag" disabled lay-verify="required">
  ...
  <%--  <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">加价幅度</label>
            <div class="layui-input-inline" style="width:30%">
                <input type="text" lay-verify="required" name="premiumAmount" class="layui-input"
  ...
  <%--  <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">退币比例</label>
            <div class="layui-input-inline" style="width:30%">
                <input type="text" lay-verify="required" name="refundMoneyProportion" class="layui-input"
                       autocomplete="off" placeholder="0" value="${auctionRule.refundMoneyProportion}"/>
            </div>
        %
    </div>
  <%--  <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">起拍价</label>
            <div class="layui-input-inline" style="width:30%">
                <input type="text" lay-verify="required" name="openingBid" class="layui-input"
