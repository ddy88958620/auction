 ...
 * recognize the word and to submit it.</li>
 * </ul>
 * 
 * @author <a href="mailto:mag@jcaptcha.net">Marc-Antoine Garrigue</a>
 * @version 1.0
 */
public class GimpyNew extends ImageCaptcha implements Serializable {

	private String response;

	GimpyNew(String question, BufferedImage challenge, String response) {
